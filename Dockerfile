...
FROM --platform=$BUILDPLATFORM docker.io/library/rust:1.97.1-slim-trixie@sha256:8e8cf8f7fd54a2d23d5a743b3a03f56e26b6c774276c33fa0595111704ebb15c AS build
...
FROM --platform=$TARGETPLATFORM docker.io/library/debian:trixie-slim@sha256:3a39a0592364683e6bab97937b72cad5a8fa6dcbbee90edb3bb48c7f8e94f258
...
# Explicitly request security-sensitive runtime packages so Debian upgrades vulnerable
# packages already present in the immutable base layer whenever fixed versions are available.
RUN mkdir /data && \
